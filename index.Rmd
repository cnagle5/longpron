...
```{r, gg-lengthsample, fig.cap="**Figure 3**. Number of Unique Samples: Study Length by Learner Age Group", fig.dim = c(7,5), warning = F}
long.data %>%
...
```{r, gg-lengthmeasurement, fig.cap = "**Figure 5**. Number of Unique Samples: Study Length by Construct", fig.dim = c(5,5), warning=F}
long.data %>%
...
```
<br>
```{r, gg-pointsmeasurement, fig.cap = "**Figure 6**. Number of Unique Samples: Study Data Points by Construct", fig.dim = c(5,5), warning = F}
long.data %>%
  pivot_longer(cols = perception:production_global,
               names_to = "construct") %>%
  filter(value == "Yes") %>%
